...
"First of all it must be stressed that very great importance is attached to the recording of variants of the same story, tradition, belief, custom, etc., from every distiict in the country. From this huge mass of variant material it will be possible for scholars to show geographical distribution of certain aspects of our oral traditions. For example, it may be discovered that a custom, belief, or story is confined to a certain area, or again, it may be found from a study of hundreds of variants of the same story, that a certain international folk-tale which is known to have three distinct types, a Central European type, an Eastern European type, and a type mainly associated with Western Europe, occurs in one or more of these types in Ireland, associated according to type with different regions of the country. Then the question will arise as to why a story which is found perhaps in Kerry and certain districts of Cork and Limerick is only known to science elsewhere from South-Eastern Europe."
